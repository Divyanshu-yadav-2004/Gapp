...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get Dashboard stats and activity lists (Admin only)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'List all payments transaction log (Admin only)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Export application records to CSV file (Admin only)' }),
