...
let NotificationGateway = NotificationGateway_1 = class NotificationGateway {
    ...
    handleJoinRoom(client, applicationId) {
    ...
    sendStatusUpdateToUser(applicationId, statusData) {
        this.server.to(applicationId).emit('status:updated', statusData);
        this.server.emit('status:updated', statusData);
    }
};
...
__decorate([
    (0, websockets_1.SubscribeMessage)('joinApplicationRoom'),
